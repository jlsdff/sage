  ...
  <main class="w-screen min-h-screen gap-4 px-8 py-4 sm:px-24 sm:py-16">
    <section class="flex flex-col items-center justify-center gap-4 sm:flex-row">
      <div class="relative w-full sm:w-80">
        ...
        <img class="w-full" src="../WEBDEV_PICS/18.png" alt="" srcset="" />
      </div>

      <div class="flex flex-col justify-between w-full h-full gap-4 items-between sm:w-80">
        <div class="flex flex-col items-start justify-start">
          <div class="flex items-center justify-start gap-2">
            <h1 class="text-2xl font-bold text-primary-200">Body Loofah</h1>
          ...
          <span class="text-base font-bold">
            <span class="font-normal">by</span> Mae Cares</span>
        </div>
    ...
    <section class="flex justify-center w-full py-4 mt-4">
      <div class="w-full sm:w-[40rem]">
        ...
        An eco-body loofah is a natural and biodegradable 
        exfoliating tool made from plant fibers. It provides 
        gentle and effective exfoliation for the skin, helping 
        to remove dead cells and promote circulation. Eco-body 
        loofahs are eco-friendly alternatives to synthetic 
        exfoliators and are typically compostable at the end 
        of their lifespan. They offer a sustainable way to 
        enhance skincare routines while minimizing environmental 
        impact.
        </p>
      </div>
    </section>
