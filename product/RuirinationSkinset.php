  ...
  <main class="w-screen min-h-screen gap-4 px-8 py-4 sm:px-24 sm:py-16">
    <section class="flex flex-col items-center justify-center gap-4 sm:flex-row">
      <div class="relative w-full sm:w-80">
        ...
        <img class="w-full" src="../WEBDEV_PICS/17.png" alt="" srcset="" />
      </div>

      <div class="flex flex-col justify-between w-full h-full gap-4 items-between sm:w-80">
        <div class="flex flex-col items-start justify-start">
          <div class="flex items-center justify-start gap-2">
            <h1 class="text-2xl font-bold text-primary-200">Ruirination Skin Set</h1>
          ...
          <span class="text-base font-bold">
            <span class="font-normal">by</span> RueFlow</span>
        </div>

        <div>
          <h2 class="text-6xl font-black text-primary-200">₱1,000</h2>
    ...
    <section class="flex justify-center w-full py-4 mt-4">
      <div class="w-full sm:w-[40rem]">
        ...
        An eco-friendly skin set consists of skincare products 
        made from natural, sustainable, and biodegradable 
        ingredients. These products are formulated without 
        harmful chemicals or additives, reducing environmental 
        impact. Eco-friendly skin sets often come in recyclable 
        or compostable packaging, minimizing waste. By choosing 
        an eco-friendly skin set, individuals can nourish and 
        care for their skin while supporting eco-conscious 
        practices.
        </p>
      </div>
    </section>
