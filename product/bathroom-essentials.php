  ...
  <main class="w-screen min-h-screen gap-4 px-8 py-4 sm:px-24 sm:py-16">
    <section class="flex flex-col items-center justify-center gap-4 sm:flex-row">
      <div class="relative w-full sm:w-80">
        ...
        <img class="w-full" src="../WEBDEV_PICS/15.png" alt="" srcset="" />
      </div>

      <div class="flex flex-col justify-between w-full h-full gap-4 items-between sm:w-80">
        <div class="flex flex-col items-start justify-start">
          <div class="flex items-center justify-start gap-2">
            <h1 class="text-2xl font-bold text-primary-200">Bathroom Essentials</h1>
          ...
          <span class="text-base font-bold">
            <span class="font-normal">by</span> franzdown</span>
        </div>

        <div>
          <h2 class="text-6xl font-black text-primary-200">₱500</h2>
    ...
    <section class="flex justify-center w-full py-4 mt-4">
      <div class="w-full sm:w-[40rem]">
        ...
        Recyclable bathroom essentials are eco-friendly products 
        made from materials that can be reused or recycled. They 
        include items like bamboo toothbrushes, refillable soap 
        dispensers, and biodegradable toilet paper. These products 
        are designed to minimize waste and promote sustainability 
        in the bathroom. By choosing recyclable bathroom essentials, 
        individuals can contribute to environmental conservation efforts 
        while maintaining hygiene and cleanliness.
        </p>
      </div>
    </section>
  </main>
