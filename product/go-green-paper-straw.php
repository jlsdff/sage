  ...
  <main class="w-screen min-h-screen gap-4 px-8 py-4 sm:px-24 sm:py-16">
    <section class="flex flex-col items-center justify-center gap-4 sm:flex-row">
      <div class="relative w-full sm:w-80">
        ...
        <img class="w-full" src="../WEBDEV_PICS/10.png" alt="" srcset="" />
      </div>

      <div class="flex flex-col justify-between w-full h-full gap-4 items-between sm:w-80">
        <div class="flex flex-col items-start justify-start">
          <div class="flex items-center justify-start gap-2">
            <h1 class="text-2xl font-bold text-primary-200">Go green, Paper Straw</h1>
          ...
          <span class="text-base font-bold">
            <span class="font-normal">by</span> Rainydei</span>
        </div>

        <div>
          <h2 class="text-6xl font-black text-primary-200">₱100</h2>
    ...
    <section class="flex justify-center w-full py-4 mt-4">
      <div class="w-full sm:w-[40rem]">
        ...
        Paper straws are eco-friendly alternatives to plastic straws, made from biodegradable materials. 
        They offer a sustainable option for enjoying beverages while reducing plastic waste. 
        Paper straws are lightweight, durable, and compostable, making them an environmentally 
        conscious choice for both consumers and businesses. They provide a simple and effective 
        way to minimize environmental impact and support sustainability efforts.
        </p>
      </div>
    </section>
  </main>
