  ...
  <main class="w-screen min-h-screen gap-4 px-8 py-4 sm:px-24 sm:py-16">
    <section class="flex flex-col items-center justify-center gap-4 sm:flex-row">
      <div class="relative w-full sm:w-80">
        <!--ambot--->
        <a href="../main-category/main_health.php" id="back-button" class="absolute top-0 w-8 cursor-pointer -left-9 sm:-left-20">
        ...
        <img class="w-full" src="../WEBDEV_PICS/19.png" alt="" srcset="" />
      </div>

      <div class="flex flex-col justify-between w-full h-full gap-4 items-between sm:w-80">
        <div class="flex flex-col items-start justify-start">
          <div class="flex items-center justify-start gap-2">
            <h1 class="text-2xl font-bold text-primary-200">Organic Matcha Powder</h1>
          ...
          <span class="text-base font-bold">
            <span class="font-normal">by</span> Matcha Mist Co.</span>
        </div>

        <div>
          <h2 class="text-6xl font-black text-primary-200">₱300</h2>
    ...
    <section class="flex justify-center w-full py-4 mt-4">
      <div class="w-full sm:w-[40rem]">
        ...
        Organic matcha powder is a finely ground green tea powder made from 
        high-quality, shade-grown tea leaves. It is rich in 
        antioxidants, vitamins, and minerals, offering various 
        health benefits. Organic matcha powder is produced without 
        synthetic pesticides or fertilizers, ensuring a pure and 
        natural product. It can be used to make traditional Japanese 
        tea or incorporated into recipes like smoothies, lattes, 
        and baked goods. Organic matcha powder provides a convenient 
        and nutritious way to enjoy the distinct flavor and health 
