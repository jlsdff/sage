  ...
  <main class="w-screen min-h-screen gap-4 px-8 py-4 sm:px-24 sm:py-16">
    <section class="flex flex-col items-center justify-center gap-4 sm:flex-row">
      <div class="relative w-full sm:w-80">
        ...
        <img class="w-full" src="../WEBDEV_PICS/11.png" alt="" srcset="" />
      </div>

      <div class="flex flex-col justify-between w-full h-full gap-4 items-between sm:w-80">
        <div class="flex flex-col items-start justify-start">
          <div class="flex items-center justify-start gap-2">
            <h1 class="text-2xl font-bold text-primary-200">Reusable Kitchen Towels</h1>
          ...
          <span class="text-base font-bold">
            <span class="font-normal">by</span> Toniflower</span>
        </div>
    ...
    <section class="flex justify-center w-full py-4 mt-4">
      <div class="w-full sm:w-[40rem]">
        ...
        Reusable kitchen towels are eco-friendly alternatives to disposable paper towels. 
        Made from durable and absorbent materials like cotton or linen, these towels can 
        be washed and reused multiple times. They offer a sustainable solution for cleaning up spills, 
        drying dishes, and general kitchen tasks. Reusable kitchen towels help reduce waste and promote 
        environmental sustainability by eliminating the need for single-use paper products. They are cost-effective, 
        convenient, and contribute to a greener household.
        </p>
      </div>
    </section>
  </main>
