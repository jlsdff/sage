  ...
  <main class="w-screen min-h-screen gap-4 px-8 py-4 sm:px-24 sm:py-16">
    <section class="flex flex-col items-center justify-center gap-4 sm:flex-row">
      <div class="relative w-full sm:w-80">
        ...
        <img class="w-full" src="../WEBDEV_PICS/14.png" alt="" srcset="" />
      </div>

      <div class="flex flex-col justify-between w-full h-full gap-4 items-between sm:w-80">
        <div class="flex flex-col items-start justify-start">
          <div class="flex items-center justify-start gap-2">
            <h1 class="text-2xl font-bold text-primary-200">Record Chandelier</h1>
          ...
          <span class="text-base font-bold">
            <span class="font-normal">by</span> ainafaye</span>
        </div>

        <div>
          <h2 class="text-6xl font-black text-primary-200">₱550</h2>
    ...
    <section class="flex justify-center w-full py-4 mt-4">
      <div class="w-full sm:w-[40rem]">
        ...
        A recyclable record chandelier is a lighting fixture crafted from 
        repurposed vinyl records. It offers a unique and eco-friendly way to 
        illuminate a space. The chandelier's design creatively incorporates old 
        records, contributing to sustainability efforts by reducing waste. With its 
        distinctive look and environmental benefits, the recyclable record chandelier 
        serves as a stylish and sustainable lighting option.
        </p>
      </div>
    </section>
  </main>
