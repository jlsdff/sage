  ...
  <main class="w-screen min-h-screen gap-4 px-8 py-4 sm:px-24 sm:py-16">
    <section class="flex flex-col items-center justify-center gap-4 sm:flex-row">
      <div class="relative w-full sm:w-80">
        ...
        <img class="w-full" src="../WEBDEV_PICS/4 (1).png" alt="" srcset="" />
      </div>

      <div class="flex flex-col justify-between w-full h-full gap-4 items-between sm:w-80">
        <div class="flex flex-col items-start justify-start">
          <div class="flex items-center justify-start gap-2">
            <h1 class="text-2xl font-bold text-primary-200">Eco Shampoo</h1>
          ...
          <span class="text-base font-bold">
            <span class="font-normal">by</span> Sharie</span>
        </div>
    ...
    <section class="flex justify-center w-full py-4 mt-4">
      <div class="w-full sm:w-[40rem]">
        ...
        Eco shampoo is a sustainable hair care product made from 
        natural and biodegradable ingredients. It is formulated 
        without harmful chemicals or additives, reducing 
        environmental impact. Eco shampoo often comes in 
        recyclable packaging, minimizing waste. By choosing 
        eco shampoo, individuals can clean their hair 
        effectively while supporting eco-friendly practices.
        </p>
      </div>
    </section>
  </main>
