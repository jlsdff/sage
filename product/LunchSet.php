  ...
  <main class="w-screen min-h-screen gap-4 px-8 py-4 sm:px-24 sm:py-16">
    <section class="flex flex-col items-center justify-center gap-4 sm:flex-row">
      <div class="relative w-full sm:w-80">
        ...
        <img class="w-full" src="../WEBDEV_PICS/4.png" alt="" srcset="" />
      </div>

      <div class="flex flex-col justify-between w-full h-full gap-4 items-between sm:w-80">
        <div class="flex flex-col items-start justify-start">
          <div class="flex items-center justify-start gap-2">
            <h1 class="text-2xl font-bold text-primary-200">Lunch Set</h1>
          ...
          <span class="text-base font-bold">
            <span class="font-normal">by</span> James Alateit</span>
        </div>

        <div>
          <h2 class="text-6xl font-black text-primary-200">₱1,200</h2>
    ...
    <section class="flex justify-center w-full py-4 mt-4">
      <div class="w-full sm:w-[40rem]">
        ...
        A recyclable lunch set is an eco-friendly option for meals on the go. 
        It includes reusable utensils and containers made from recyclable materials. 
        This set typically consists of items like a bento box, utensils, and a water bottle, 
        all designed to minimize waste. It provides a convenient and sustainable solution for 
        packing lunches, reducing the use of disposable plastics.
        </p>
      </div>
    </section>
  </main>
