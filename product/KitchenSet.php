  ...
  <main class="w-screen min-h-screen gap-4 px-8 py-4 sm:px-24 sm:py-16">
    <section class="flex flex-col items-center justify-center gap-4 sm:flex-row">
      <div class="relative w-full sm:w-80">
        ...
        <img class="w-full" src="../WEBDEV_PICS/9.png" alt="" srcset="" />
      </div>

      <div class="flex flex-col justify-between w-full h-full gap-4 items-between sm:w-80">
        <div class="flex flex-col items-start justify-start">
          <div class="flex items-center justify-start gap-2">
            <h1 class="text-2xl font-bold text-primary-200">Kitchen Set | Tamara</h1>
          ...
          <span class="text-base font-bold">
            <span class="font-normal">by</span> ElissaD</span>
        </div>

        <div>
          <h2 class="text-6xl font-black text-primary-200">₱3,000</h2>
    ...
    <section class="flex justify-center w-full py-4 mt-4">
      <div class="w-full sm:w-[40rem]">
        ...
        A wooden kitchen set comprises various utensils and appliances crafted from wood. 
        It typically includes items like spoons, spatulas, bowls, cutting boards, and 
        rolling pins, among others. These kitchen tools are made from durable and 
        eco-friendly materials, providing a natural and rustic aesthetic to any kitchen. 
        Wooden kitchen sets are renowned for their longevity, ease of maintenance, and 
        resistance to heat and moisture. With their classic charm and practical functionality, 
        wooden kitchen sets are essential additions to any culinary space.
