  ...
  <main class="w-screen min-h-screen gap-4 px-8 py-4 sm:px-24 sm:py-16">
    <section class="flex flex-col items-center justify-center gap-4 sm:flex-row">
      <div class="relative w-full sm:w-80">
        ...
        <img class="w-full" src="../WEBDEV_PICS/7.png" alt="" srcset="" />
      </div>

      <div class="flex flex-col justify-between w-full h-full gap-4 items-between sm:w-80">
        <div class="flex flex-col items-start justify-start">
          <div class="flex items-center justify-start gap-2">
            <h1 class="text-2xl font-bold text-primary-200">Veggie Bag</h1>
        ...
        <div>
          <h2 class="text-6xl font-black text-primary-200">₱250</h2>
    ...
    <section class="flex justify-center w-full py-4 mt-4">
      <div class="w-full sm:w-[40rem]">
        ...
        <p class="py-2 text-base text-justify text-primary-200">
          Introducing our ReVeg Bag: a sustainable shopping essential crafted
          from recycled materials. This durable bag is designed to accompany
          you on every trip to the market or grocery store, providing ample
          space for your fresh produce. With its eco-friendly construction,
          the Veggie Bag helps reduce single-use plastic waste while promoting
          responsible shopping practices. Its lightweight design ensures easy
          transport, making it convenient for everyday use. Choose the ReVeg
          Bag and join us in our commitment to a greener, more sustainable
          future.
        </p>
      </div>
    </section>
