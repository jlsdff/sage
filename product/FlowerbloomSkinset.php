  ...
  <main class="w-screen min-h-screen gap-4 px-8 py-4 sm:px-24 sm:py-16">
    <section class="flex flex-col items-center justify-center gap-4 sm:flex-row">
      <div class="relative w-full sm:w-80">
        ...
        <img class="w-full" src="../WEBDEV_PICS/16.png" alt="" srcset="" />
      </div>

      <div class="flex flex-col justify-between w-full h-full gap-4 items-between sm:w-80">
        <div class="flex flex-col items-start justify-start">
          <div class="flex items-center justify-start gap-2">
            <h1 class="text-2xl font-bold text-primary-200">Flowerbloom Skin Set</h1>
          ...
          <span class="text-base font-bold">
            <span class="font-normal">by</span> Floweknows</span>
        </div>

        <div>
          <h2 class="text-6xl font-black text-primary-200">₱1,500</h2>
    ...
    <section class="flex justify-center w-full py-4 mt-4">
      <div class="w-full sm:w-[40rem]">
        ...
        A recyclable skin bottle set consists of skincare 
        containers made from materials that can be reused or 
        recycled. These bottles are designed to minimize waste 
        and promote sustainability in the skincare industry. 
        They are typically made from recyclable plastics or 
        glass, allowing for easy recycling after use. By opting 
        for a recyclable skin bottle set, individuals can support 
        environmental conservation efforts while maintaining 
