  ...
  <main class="w-screen min-h-screen gap-4 px-8 py-4 sm:px-24 sm:py-16">
    <section class="flex flex-col items-center justify-center gap-4 sm:flex-row">
      <div class="relative w-full sm:w-80">
        ...
        <img class="w-full" src="../WEBDEV_PICS/13.png" alt="" srcset="" />
      </div>

      <div class="flex flex-col justify-between w-full h-full gap-4 items-between sm:w-80">
        <div class="flex flex-col items-start justify-start">
          <div class="flex items-center justify-start gap-2">
            <h1 class="text-2xl font-bold text-primary-200">Kitchen Sponge</h1>
          ...
          <span class="text-base font-bold">
            <span class="font-normal">by</span> ecojiko</span>
        </div>
    ...
    <section class="flex justify-center w-full py-4 mt-4">
      <div class="w-full sm:w-[40rem]">
        ...
        A recyclable kitchen sponge is an eco-friendly cleaning tool made from biodegradable 
        materials. It's designed for washing dishes, wiping countertops, and other 
        kitchen tasks. Once worn out, the sponge can be composted or recycled, reducing waste. 
        With its absorbent and durable properties, the recyclable kitchen sponge offers a 
